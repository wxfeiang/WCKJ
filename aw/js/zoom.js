(function(e) {
    ...
    function a() {
        var t = i.parents(".slick-slide").prev();
        if (t.length == 0) t = e(".gallery .slick-slide:last-child");
        t.find("a").trigger("click")
    }
    function f() {
        var t = i.parents(".slick-slide").next();
        if (t.length == 0) t = e(".gallery .slick-slide:first-child");
        t.find("a").trigger("click")
    }
    function l(s) {
